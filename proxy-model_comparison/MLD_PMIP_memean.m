...
% define bins (very roughly)
nbins=(20+84)/2;
edges=linspace(-84,20,nbins+1);
...
for i=1:length(modelList)
    ...
    for nb=1:nbins
        ...
        idx=nav_lon>=edges(nb) & nav_lon<edges(nb+1);
        if any(idx,'all')
...
exportgraphics(gcf,'./plots/formal/S5winter-anom_mmean.tiff','Resolution',300)